...
<nav class="navbar navbar-inverse" style="color: rgb(212, 218, 223);">
  ...
  <div class="card-container">
    ...
    <div class="col-md-6 col-lg-3">
      <div class="card">
        <img src="avalia.JPG" class="logo1" alt="..." style="width: 70%;height: 70%; position: relative;left: 18px;">
        <div class="card-body">
