...
<input style=" height:26px;width:178px;position: relative;top:310px;left: -175px;" type="text" id="filtro-id" placeholder="Filtrar por ID" onkeyup="filtrarTabela('id')"> </div>
...
echo '<thead>';
echo '<tr>';
echo '<th colspan="5" class="table-title">Lista de Usuários</th>'; // Título da tabela
echo '</tr>';
echo '<tr>';
echo '<th>ID</th>';
echo '<th>Nome</th>';
...
echo '<tbody id="usuario-list">'; 
    ...
    while($row = $result->fetch_assoc()) {
        ...
        echo '<td ><img style="width:40px;height:40px;"src='.$row["Foto"].'></img></td>';
