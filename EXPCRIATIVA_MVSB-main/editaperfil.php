...
if ($result->num_rows > 0) {
    ...
    // Exibe os dados do usuário em uma tabela estilizada
        ...
        echo "<tr>";
        echo "<td style='padding: 15px; width: 100px; font-size: larger;'>Nome:</td>";
        echo "<td style='padding: 10px; font-size: larger;'>" . $row['Nome'] . " </td>";
        echo "</tr>";
        echo "<tr>";
        echo "<td style='padding: 15px; width: 100px; font-size: larger;'>Senha:</td>";
        echo "<td style='padding: 10px; font-size: larger;'>" . $senha_u . "</td>";
        echo "</tr>";
        echo "<tr>";
        echo "<td style='padding: 15px; width: 100px; font-size: larger;'>Foto:</td>";
        echo "<td style='padding: 10px; font-size: larger;'><img src='" . $row['Foto'] . "' style='max-width: 100px; max-height: 100px;'></td>";
        echo "</tr>";
        echo "</table>";
